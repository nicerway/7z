				...
				<div class="miaoshu clr">
					<div id="tab1" class="tabson">
						...
						<form id="dataForm" class="layui-form" method="post" enctype="multipart/form-data">
							...
							$opt->jsonStart('团队人员', 'team', [
								    'team_name' => '姓名',
								    'team_post' => '职位',
								    'team_linkedin' => 'linkedin',
							    ])
							->jsonEnd();
							echo '<input type="hidden" value="$opt->jsonStart(\'团队人员\', \'team\', ['.PHP_EOL.'
								    \'team_name\' => \'姓名\','.PHP_EOL.'
								    \'team_post\' => \'职位\','.PHP_EOL.'
								    \'team_linkedin\' => \'linkedin\','.PHP_EOL.'
							    ])
							->jsonEnd();">';
